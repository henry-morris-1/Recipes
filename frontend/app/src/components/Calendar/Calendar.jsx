    ...
    return (
        <>
            ...
            <Modal title={ dateString } ref={ modalRef }>
                {day.recipeId && <>
                    <Link to={"/recipes/" + day.recipeId} role="button" className="px-3 py-4 flex items-center justify-center w-full rounded-full shadow-md bg-neutral-600 text-sm font-bold leading-4">
                        {day.recipeName}
                ...
                <select className="px-3 py-4 mb-3 overflow-hidden w-full rounded-full shadow-md bg-neutral-600 text-sm font-bold leading-4 text-ellipsis whitespace-pre" name="Set recipe" value={JSON.stringify(selected)} onChange={handleChange}>
                ...
                <div className="flex items-center justify-end mt-3">
                    <button className="px-3 py-1 bg-neutral-600 shadow-md rounded-3xl select-none text-sm font-semibold click-toggle">
                        Cancel
                    </button>
                    <button className="ms-3 px-3 py-1 bg-blue-600 shadow-md rounded-3xl select-none text-sm font-semibold click-toggle" onClick={ save }>
                        Save
                    </button>
                </div>
            </Modal>
