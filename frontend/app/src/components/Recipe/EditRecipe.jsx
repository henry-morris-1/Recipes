...
/**
 * Modal for updating and existing recipe. Upon submission, the updated recipe page is 
 * shown.
 * @param {Object} recipe Recipe state being edited
...
export default function EditRecipe ({ recipe, setRecipe }) {
    ...
    const [aRating, setARating] = useState(recipe.aRating);
    ...
    function handleSubmit (event) {
        ...
        // Make the API call and set the updated recipe
        api.updateRecipe(recipe.id, newRecipe).then(response => {
